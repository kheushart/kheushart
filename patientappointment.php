...
if(isset($_POST[submit]))
{
	...
	{
		echo "<script>alert('Rendez-vous déjà prévu pour cette période..');</script>";
	}
	else
	{
...
?>
          ...
          <option value="">Selectionner department</option>
          <?php
		  ...
		  ?>
           ...
           <strong>Docteurs</strong> 
           
			<div id="divdoc">
			  <select name="doct" id="doct">
			  <option value="">Selectionner Docteur</option>          
			  </select>   
			</div>
           
                 
          
           <strong>Appointment Raison</strong> 
