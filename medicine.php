...
<div class="wrapper col4">
  <div id="container">
    ...
    <form method="post" action="" name="frmmedicine" onSubmit="return validateform()">
         ...
         Medicine<input type="text" name="medicinename" id="medicinename" value="<?php echo $rsedit[medicinename]; ?>" /> 
         
         
		Cost(NGN)
		<input type="text" name="medicinecost" id="medicinecost" value="<?php echo $rsedit[medicinecost]; ?>" /> 
         
         
		Description <br>  
		<textarea name="description" id="description" cols="134" rows="2"><?php echo $rsedit[description] ; ?></textarea> 
