...
<form method="post" class="box" action="" name="frmpatlogin" onSubmit="return validateform()">
        <h1>Se Connecter</h1>
        <center>
  <input type="text" name="loginid" id="loginid" placeholder="Login Id"/></td><br>
        <input type="password" name="password" id="password" placeholder="Mot de Passe" /><br>
         <input type="submit" name="submit" id="submit" value="Login" />
			</center>
			<a href="patient.php" style="color:white">Creer Compte </strong> | 
		<a href="patientforgotpassword.php" style="color:white"><strong>Mot de Passe Oubliée</strong></a></td>
		</form>
