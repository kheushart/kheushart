...
<html lang="en">
<head>
<title>Sama Wergui Yaram</title> 
<!-- For-Mobile-Apps-and-Meta-Tags -->
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Staion hospital, hospital in lagos, buydrugs" />
...
<body class="bg">
		...
		<section class="header-w3ls"> 
			...
			<a class="page-scroll" href="patientlogin.php" ><i class="fa fa-sign-in" aria-hidden="true"></i>Patient Login</a>.
			<a class="page-scroll" href="doctorlogin.php" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Docteur Login</a>
			</div>
		<h1><a href="main.html">Sama Wergui Yaram</a></h1>
...
<div class="banner-bottom">
	<div class="bnr-btm-grids-agileits">
		...
		<div class="bnr-btm-info">
			<h3>Vous pouvez nous appeller</h3>
			<p>33 909 99 90 </p>
		</div>
		<div class="clearfix"> </div>
	</div>
	<div class="bnr-btm-grids-agileits">
		...
		<div class="bnr-btm-info">
			...
			<p><a href="info@example.com">infosamawerguiyaram@gmail.com</a></p>
		</div>
		<div class="clearfix"> </div>
	</div>
	<div class="bnr-btm-grids-agileits">
...
<!-- footer -->
	<div class="footer">
		<div class="agileinfo_footer_bottom1">
			<div class="container">
					<p>© 2022 SAMA WERGUI YARAM. All rights reserved | Projet <a href="#">HACKATON</a></p>
				<div class="clearfix"> </div>
			</div>
		</div>
	</div>
