    ...
    <table width="200" border="3">
      <tbody>
        ...
        <tr>
		  ...
		  <?php
		$sqlmedicine ="SELECT * FROM medicine WHERE status='Instock'";
		$qsqlmedicine = mysqli_query($con,$sqlmedicine);
		while($rsmedicine = mysqli_fetch_array($qsqlmedicine))
		{
			echo "<option value='$rsmedicine[medicineid]'>$rsmedicine[medicinename] ( NGN $rsmedicine[medicinecost] )</option>";
		}
		?>
		  </select>
		  </td>
    ...
    <table width="200" border="3">
      <tbody>
        ...
        echo "<tr>
          ...
          <td>&nbsp;NGN$rs[cost]</td>
		   <td>&nbsp;$rs[unit]</td>
		   <td  align='right'>NGN" . $rs[cost] * $rs[unit] . "</td>";
			if(!isset($_SESSION[patientid]))
			{
        ...
        <tr>
		  ...
		  <th align="right">NGN<?php echo $gtotal; ?></th>
		  <td></td>
          </tr>
        <tr>
