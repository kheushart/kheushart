...
if(isset($_POST[submit]))
{
	if(isset($_GET[editid]))
	{
		...
		{
			echo "<script>alert('patient mise a jour avec succes...');</script>";
		}
		else
		{
	...
	if($qsql = mysqli_query($con,$sql))
	{
		echo "<script>alert('Dossier patient inséré avec succès...');</script>";
...
<div class="wrapper col4">
  <div id="container">
    <h1>Panneau d'enregistrement du profil du patient</h1>
...
?>
		 ...
		 Adresse<input type="text" name="adress" id="address" value="<?php echo $rsedit[mobileno]; ?>" />
		 Numéro de portable 
           ...
           Identifiant de connexion (Votre adresse email)
