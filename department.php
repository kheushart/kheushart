...
if(isset($_POST[submit]))
{
	if(isset($_GET[editid]))
	{
		...
		{
			echo "<script>alert('dossier de service mis à jour avec succès...');</script>";
		}
		else
		{
...
<div class="wrapper col4">
  <div id="container">
    <h1>Ajouter Nouveau departement</h1>
