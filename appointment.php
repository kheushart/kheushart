...
if(isset($_POST[submit]))
{
		if(isset($_GET[editid]))
		{
			...
			{
				echo "<script>alert('enregistrement de rendez-vous mis à jour avec succès...');</script>";
			}
			else
			{
...
<div class="wrapper col4">
  <div id="container">
    <h1>Ajouter un nouvel enregistrement de rendez-vous</h1>
  ...
  echo "<option value='$rsdepartment[departmentid]'>$rsdepartment[departmentname]</option>";
		...
		?>
		   ...
		   Motifs
		   <textarea name="textarea" id="textarea" cols="134" rows="2"><?php echo $rsedit[app_reason] ; ?></textarea> <br>
...
function validateform()
{
	...
	{
		alert("Selectionner le status s'il vous plait");
